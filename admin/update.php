      ...
      <div class="flex">
         <div class="col">
            ...
            <select name="profession" class="box">
               ...
               <option value="biologist">Sinh vật học</option>
         ...
         <div class="col">
            <p>Mật khẩu cũ :</p>
            <input type="password" name="old_pass" placeholder="...." maxlength="20"  class="box">
            <p>Mật khẩu mới :</p>
            <input type="password" name="new_pass" placeholder="..." maxlength="20"  class="box">
            <p>Xác nhận mật khẩu :</p>
            <input type="password" name="cpass" placeholder="..." maxlength="20"  class="box">
         </div>
      </div>
      <p>Hình ảnh :</p>
