...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Tạo danh sách phát mới</h3>
         <a href="add_playlist.php" class="btn">Tạo</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="xóa" class="delete-btn" onclick="return confirm('Bạn muốn xóa danh sách phát này?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Xem</a>
      </div>
      <?php
         } 
      }else{
