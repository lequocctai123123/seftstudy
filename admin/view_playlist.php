   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="xóa" class="delete-btn" onclick="return confirm('Bạn có muốn xóa?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">Không có danh sách phát nào được tìm thấy!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <h1 class="heading">Video trong danh sách phát</h1>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Xem</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Không có video nào! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm video</a></p>';
      }
   ?>
