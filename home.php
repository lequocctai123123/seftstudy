...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="likes.php" class="inline-btn">Xem</a>
         <p>Bình luận : <span><?= $total_comments; ?></span></p>
         <a href="comments.php" class="inline-btn">Xem</a>
         <p>Lưu danh sách phát : <span><?= $total_bookmarked; ?></span></p>
         <a href="bookmark.php" class="inline-btn">Xem</a>
      </div>
      <?php
         }else{ 
      ?>
