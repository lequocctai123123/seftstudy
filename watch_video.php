...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-heart"></i><span><?= $total_likes; ?> lượt thích</span></p>
      </div>
      <div class="tutor">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">Xem danh sách phát</a>
         <?php
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="......" maxlength="1000" cols="30" rows="10"></textarea>
      <input type="submit" value="Thêm" name="add_comment" class="inline-btn">
   </form>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Chỉnh sửa</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Bạn muốn xóa bình luận này?');">Xóa</button>
         </form>
         <?php
         }
         ?>
