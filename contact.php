...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         <h3>Gửi Email</h3>
         <input type="text" placeholder="Tên..." required maxlength="100" name="name" class="box">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Số Điện Thoại</h3>
         <a href="tel:1234567890">0834 678 336</a>
         <a href="tel:1112223333">0834 752 999</a>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>Email</h3>
         <a href="mailto:shaikhanas@gmail.com">educa@gmail.com</a>
         <a href="mailto:anasbhai@gmail.com">ducati@gmail.com</a>
      </div>

      <div class="box">
         <i class="fas fa-map-marker-alt"></i>
         <h3>Địa Chỉ</h3>
         <a href="#">338 An Dương Vương , Quận 5 , TP.HCM</a>
      </div>
